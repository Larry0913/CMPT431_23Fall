...
void pageRankCalParallel(PageRankType *pr_curr, std::atomic<PageRankType> *pr_next, uintV start, uintV end, CustomBarrier *my_barrier, int max_iters, int thread_id)
{
